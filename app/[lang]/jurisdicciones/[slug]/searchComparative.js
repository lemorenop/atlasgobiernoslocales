    ...
    <div className={`relative flex flex-col gap-xs justify-between`}>
      ...
      <Combobox value={value} onChange={onChange}>
        ...
        <ComboboxOptions
          ...
          transition
          className={
            "z-40 bg-white border [--anchor-gap:var(--spacing-1)] empty:invisible transition duration-100 ease-in data-[leave]:data-[closed]:opacity-0  cursor-pointer p-s max-h-[300px] overflow-y-auto w-[400px]"
          }
        >
          {results.map((item) => (
            <ComboboxOption
